...
#First section
   ...
   print("You will now be prompted to enter additional metadata\n" \
      "about " + metadata['title'] + " in the form of key-value pairs. When\n" \
...
#      print("\t" + title + " was successfully loaded")
...
#                          #
system("clear")
chdir("/Users/Colin/Developer/QuoteMap/")
