#Delete this import...only need for testing
...
class Book(object):
   ...
   def __init__(self, metadata, quotes = []):
      """Initializes a Book with its title, author, publication year,
         ...
         meta  :  dictionary of attirbutes of the book, including
   ...
   def writeData(self):
      jsonData = {'quotes': self.serializeQuotes(), 'metadata': self.metadata}
#      print(jsonData)
